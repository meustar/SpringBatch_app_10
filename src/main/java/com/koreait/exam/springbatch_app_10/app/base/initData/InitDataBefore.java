...
public interface InitDataBefore {
    default void before(MemberService memberService, SongService songService, ProductService productService) {
        ...
        productService.create(song1, "상품 2", 2_900);
        productService.create(song1, "상품 3", 3_900);
        productService.create(song1, "상품 4", 4_900);
        productService.create(song1, "상품 5", 5_900);
